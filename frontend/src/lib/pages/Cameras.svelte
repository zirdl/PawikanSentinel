...
<div class="page-content">
  <header class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
    ...
    <button class="btn-gradient-primary flex items-center gap-2">
  ...
  {:else}
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
      ...
      <!-- Add New Feed Card -->
      <button class="border-2 border-dashed border-outline-variant rounded-xl flex flex-col items-center justify-center p-8 group hover:border-primary transition-all min-h-[340px] bg-surface-container-low/30">
